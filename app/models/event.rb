class Event < ApplicationRecord
  ...
  THEMATICS = ["Sports nautiques", "Sports extrêmes", "Sensations", "Gastronomie", "Bien-être", "Nature", "Sports mécaniques", "Loisirs créatifs", "Ludique", "Culture", "Sans tabou"].freeze
