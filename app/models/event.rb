class Event < ApplicationRecord
  ...
  THEMATICS = ["Sports nautiques", "Sports extrêmes", "Sensations", "Gastronomie", "Bien-être", "Nature", "Sports mécaniques", "Loisirs créatifs", "Ludique", "Culture", "Musique", "Sans tabou"].freeze
